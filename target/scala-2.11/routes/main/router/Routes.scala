...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:19
    Assets_1: controllers.Assets
  ) = this(errorHandler, HomeController_0, ApplicationController_2, Assets_1, "/")

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_0, ApplicationController_2, Assets_1, prefix)
  }
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_ApplicationController_index3_route(params@_) =>
      call { 
        controllers_ApplicationController_index3_invoker.call(ApplicationController_2.index)
      }
    ...
    case controllers_ApplicationController_read5_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ApplicationController_read5_invoker.call(ApplicationController_2.read(id))
      }
  
    // @LINE:15
    case controllers_ApplicationController_update6_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ApplicationController_update6_invoker.call(ApplicationController_2.update(id))
      }
  
    // @LINE:16
    case controllers_ApplicationController_delete7_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ApplicationController_delete7_invoker.call(ApplicationController_2.delete(id))
      }
